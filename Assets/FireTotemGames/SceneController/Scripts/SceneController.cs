...
namespace FTG.SceneController
{
    public class SceneController : MonoBehaviour
    {
        ...
        [Header("Fade Out")]
        [SerializeField] private float fadeOutTimeDefault = 0.3f;
        [SerializeField] private AnimationCurve fadeOutCurve = AnimationCurve.Linear(0f, 0f, 1f, 1f);

        [Header("In Between")]
        [SerializeField] private float waitTimeDefault = 0.1f;

        [Header("Fade In")]
        [SerializeField] private float fadeInTimeDefault = 0.3f;
